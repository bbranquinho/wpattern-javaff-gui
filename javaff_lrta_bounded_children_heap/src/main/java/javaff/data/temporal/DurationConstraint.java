...
public class DurationConstraint implements PDDLPrintable
{
	...
	{
		boolean rTest = true;
		Iterator cit = this.constraints.iterator();
	...
	{
		return this.getMaxDuration(ms);
	}

	public BigDecimal getMaxDuration(MetricState ms)
	{
		BigDecimal sofar = AlgorithmConstants.MAX_DURATION;
		Iterator cit = this.constraints.iterator();
		while (cit.hasNext())
		{
			SimpleDurationConstraint c = (SimpleDurationConstraint) cit.next();
	...
	public boolean equals(Object obj)
	{
		if (obj instanceof DurationConstraint)
		{
			...
			return c.constraints.equals(this.constraints);
		}
		else return false;
	}
}
