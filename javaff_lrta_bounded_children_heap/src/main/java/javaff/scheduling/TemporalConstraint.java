...
public class TemporalConstraint extends Constraint
{
	...
	{
		return new TemporalConstraint(first, second, AlgorithmConstants.EPSILON.negate());
	}
	...
	{
		return (this.x.toString() + " - " + this.y.toString() +" <= "+this.b.toString());
	}
	...
	public boolean equals(Object obj)
	{
		if (obj instanceof TemporalConstraint)
		{
			...
			return (c.x.equals(this.x) && c.y.equals(this.y) && c.b.equals(this.b));
		}
		return false;
	}
